...
describe('ProgressBar', () => {
  it('renders round label with i18n key', () => {
    const { getByText } = render(
      <ProgressBar currentRound={1} totalRounds={2} currentExerciseIndex={0} totalExercises={3} />,
    );
  ...
  it('renders exercise label with i18n key', () => {
    const { getByText } = render(
      <ProgressBar currentRound={1} totalRounds={2} currentExerciseIndex={1} totalExercises={3} />,
    );
  ...
  it('shows partial progress for mid-workout', () => {
    const { container } = render(
      <ProgressBar currentRound={1} totalRounds={2} currentExerciseIndex={2} totalExercises={3} />,
    );
    const bar = container.querySelector('[style]')!;
