...
const HEADERS_CSP =
  "default-src 'self'; script-src 'self' https://www.googletagmanager.com https://eu-assets.i.posthog.com; style-src 'self' 'unsafe-inline'; connect-src 'self' wss://*.convex.cloud https://*.convex.cloud https://accounts.google.com https://*.google-analytics.com https://*.analytics.google.com https://*.ingest.sentry.io https://*.i.posthog.com; frame-src https://accounts.google.com; img-src 'self' data:; worker-src 'self'; base-uri 'self'";
...
const EXPECTED = [
  ...
  ['https://*.google-analytics.com', 'connect-src'],
