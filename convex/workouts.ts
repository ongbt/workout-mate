...
export const seedDefaults = mutation({
  handler: async (ctx) => {
    ...
    await ctx.db.insert("defaultWorkouts", {
      name: "Full Body",
      exercises: [
        { id: crypto.randomUUID(), name: "Chest - Push-ups", durationSeconds: 45 },
        { id: crypto.randomUUID(), name: "Shoulder - Dumbbell - Right", durationSeconds: 25 },
        { id: crypto.randomUUID(), name: "Shoulder - Dumbbell - Left", durationSeconds: 25 },
        { id: crypto.randomUUID(), name: "Bicep - Dumbbell - Right", durationSeconds: 25 },
        { id: crypto.randomUUID(), name: "Bicep - Dumbbell - Left", durationSeconds: 25 },
        { id: crypto.randomUUID(), name: "Tricep - Dumbbell - Right", durationSeconds: 25 },
        { id: crypto.randomUUID(), name: "Tricep - Dumbbell - Left", durationSeconds: 25 },
        { id: crypto.randomUUID(), name: "Abs - Plank", durationSeconds: 45 },
        { id: crypto.randomUUID(), name: "Abs - Power Over", durationSeconds: 45 },
        { id: crypto.randomUUID(), name: "Abs - Reverse Corkscrew", durationSeconds: 45 },
        { id: crypto.randomUUID(), name: "Abs - Bicycle Crunches", durationSeconds: 45 },
        { id: crypto.randomUUID(), name: "Legs - Squats", durationSeconds: 45 },
        { id: crypto.randomUUID(), name: "Legs - Lunges", durationSeconds: 45 },
        { id: crypto.randomUUID(), name: "Back - Overheads - Right", durationSeconds: 25 },
        { id: crypto.randomUUID(), name: "Back - Overheads - Left", durationSeconds: 25 },
      ],
      restSeconds: 45,
    ...
    await ctx.db.insert("defaultWorkouts", {
      ...
      exercises: [
        ...
        { id: crypto.randomUUID(), name: "Diamond Push-ups", durationSeconds: 30 },
    ...
    await ctx.db.insert("defaultWorkouts", {
      ...
      exercises: [
        ...
        { id: crypto.randomUUID(), name: "Bicycle Crunches", durationSeconds: 30 },
      ],
      restSeconds: 30,
      restBetweenRoundsSeconds: 60,
      rounds: 3,
    ...
    await ctx.db.insert("defaultWorkouts", {
      ...
      exercises: [
        ...
        { id: crypto.randomUUID(), name: "Mountain Climbers", durationSeconds: 20 },
